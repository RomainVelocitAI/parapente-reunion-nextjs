      ...
      <div className="h-screen flex items-center justify-center p-8 sticky top-0">
        <div className="relative">
          ...
          >
            ...
            >
              <div className="w-[400px] h-[400px] rounded-full bg-gradient-to-r from-[#1e40af] via-[#fbbf24] to-[#f97316] p-0.5 flex items-center justify-center relative">
                <div className="w-full h-full rounded-full bg-[#ffffff] dark:bg-black flex items-center justify-center relative">
                  ...
                  >
                    <h1 className="text-4xl font-bold text-[#1e40af] text-center mb-2">Ils ont volé</h1>
                    <h1 className="text-4xl font-bold text-[#1e40af] text-center mb-4">avec nous</h1>

                    <p className="text-[#1e40af]/80 text-center max-w-xs">
