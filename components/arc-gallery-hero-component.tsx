          ...
          {!hideButtons && (
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3 rounded-full border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white transition-all duration-200"
              >
                {secondaryButtonText}
              </button>
            </div>
