...
export const metadata = {
  title: 'Vol Marmaille Parapente Réunion | Baptême Enfant dès 5 ans - 80€',
  description: 'Vol parapente pour enfants à La Réunion. Baptême de l\'air adapté dès 5 ans avec moniteurs spécialisés. Vol Marmaille Saint-Leu en toute sécurité - 80€',
  keywords: 'parapente enfant réunion, vol marmaille saint-leu, baptême parapente 5 ans réunion, parapente enfant 974',
...
export default function VolMarmaillePage() {
  const productSchema = generateProductSchema({
    name: "Vol Marmaille Parapente Réunion",
    description: "Vol parapente adapté pour enfants dès 5 ans à Saint-Leu, La Réunion. Baptême de l'air en toute sécurité avec moniteurs spécialisés.",
    image: "https://parapente-reunion.fr/images/galerie/vol-marmaille-hero-1.jpg",
    lowPrice: "80",
    highPrice: "80",
    url: "https://parapente-reunion.fr/tarif-parapente-enfant-reunion",
    reviewCount: "95",
    ratingValue: "4.9"
  })

  const faqSchema = generateFAQSchema(faqVolMarmaille)
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4">
        <Breadcrumbs
          items={[
            ...
            { label: 'Vol Marmaille', href: '/tarif-parapente-enfant-reunion' },
          ]}
        />
      </div>
