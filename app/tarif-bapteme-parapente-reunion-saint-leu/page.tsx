...
export const metadata = {
  title: 'Tarif Baptême Parapente Réunion | Vol Découverte Saint-Leu dès 90€',
  description: 'Tarifs vol découverte parapente à La Réunion : 15-60 min de vol tandem avec moniteur diplômé. Prix baptême de l\'air à Saint-Leu dès 90€. Réservation en ligne, vue lagon garantie.',
  keywords: 'tarif parapente réunion, prix baptême parapente saint-leu, vol découverte réunion, tarif vol tandem 974, prix parapente réunion',
...
export default function VolDecouvertePage() {
  ...
  const productSchema = generateProductSchema({
    name: "Vol Découverte Parapente Réunion",
    description: "Vol tandem parapente à Saint-Leu avec moniteur diplômé d'État. 15 à 60 minutes de vol au-dessus du lagon turquoise de La Réunion.",
    image: "https://parapente-reunion.fr/images/galerie/vol-decouverte-hero-1.jpg",
    lowPrice: "90",
    highPrice: "160",
    url: "https://parapente-reunion.fr/tarif-bapteme-parapente-reunion-saint-leu",
    reviewCount: "180",
    ratingValue: "4.9"
  })

  const faqSchema = generateFAQSchema(faqVolDecouverte)
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4">
        <Breadcrumbs
          items={[
            ...
            { label: 'Vol Découverte', href: '/tarif-bapteme-parapente-reunion-saint-leu' },
          ]}
        />
      </div>
